...
enum SpaceIndicatorKind: Equatable, Sendable {
    /// The associated value is the desktop-only index used for custom colors.
    case desktop(colorIndex: Int)
    /// Full-screen Spaces retain the color of the desktop they originated from.
...
struct SpaceSnapshot: Equatable, Sendable {
    ...
    /// Only regular desktop Spaces. Kept separately for desktop-specific actions.
